...
api_single_call_url = app_config['api_single_call_url']

#
# Open the call JSON file
with open('./config/call_config_test.json', 'r') as f:
...
response = requests.post(api_single_call_url, json=data, headers=headers)
